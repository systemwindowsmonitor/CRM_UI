...
namespace CRM_UI.Storage
{
    ...
    public partial class Navigation_Bar : UserControl
    {
        ...
        private void btnCloseMaterial_Click(object sender, RoutedEventArgs e)
        {
            //btnOpenMaterial.Visibility = Visibility.Visible;
            //btnCloseMaterial.Visibility = Visibility.Collapsed;
